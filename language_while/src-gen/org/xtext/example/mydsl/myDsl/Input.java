...
public interface Input extends EObject
{
   ...
   * @see #setVar1(String)
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getInput_Var1()
   * @model
   * @generated
   */
  String getVar1();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myDsl.Input#getVar1 <em>Var1</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getInput_Var2()
   * @model unique="false"
   * @generated
   */
