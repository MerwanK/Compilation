...
public class OutputImpl extends MinimalEObjectImpl.Container implements Output
{
  ...
  public void setVar1(String newVar1)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.OUTPUT__VAR1, oldVar1, var1));
  }
  ...
  public EList<String> getVar2()
  {
    if (var2 == null)
    {
      var2 = new EDataTypeEList<String>(String.class, this, MyDslPackage.OUTPUT__VAR2);
    }
    return var2;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.OUTPUT__VAR1:
        return getVar1();
      case MyDslPackage.OUTPUT__VAR2:
        return getVar2();
    }
