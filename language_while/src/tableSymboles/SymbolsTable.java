...
public class SymbolsTable {
	...
	private HashMap<String, HashMap<String, String>> tableSymbols; 	// Une map avec pour clé le nom de la fonction associée à cette table des symboles 
	...
	public SymbolsTable(){
		...
		tableSymbols = new HashMap<String, HashMap<String, String>>();
	}
	...
	*/
	...
	public void putSymbol(String nameFunction, String nameSymb, String value){
		HashMap<String, String> symbols = tableSymbols.get(nameFunction);
		symbols.putIfAbsent(nameSymb, value);
	}
	...
	public void putSymbol(String nameFunction, String nameSymb){
		HashMap<String, String> symbols = tableSymbols.get(nameFunction);
		symbols.putIfAbsent(nameSymb, "");
	}
	...
	public String toString() {
		return "SymbolsTable [tableFunctions=" + tableFunctions + ", tableSymbols="+ tableSymbols + "]";
	}
