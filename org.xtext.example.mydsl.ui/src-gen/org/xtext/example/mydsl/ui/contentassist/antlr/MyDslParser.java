		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAffectVarAccess().getVarAssignment_0(), "rule__AffectVar__VarAssignment_0");
					...
					put(grammarAccess.getWhileAccess().getComAssignment_6(), "rule__While__ComAssignment_6");
					put(grammarAccess.getForAccess().getExp2Assignment_2(), "rule__For__Exp2Assignment_2");
					put(grammarAccess.getForAccess().getComAssignment_6(), "rule__For__ComAssignment_6");
					put(grammarAccess.getIfAccess().getExp3Assignment_2(), "rule__If__Exp3Assignment_2");
					put(grammarAccess.getIfAccess().getCom2Assignment_6(), "rule__If__Com2Assignment_6");
					put(grammarAccess.getIfAccess().getCom3Assignment_8_2(), "rule__If__Com3Assignment_8_2");
					put(grammarAccess.getForeachAccess().getExp4Assignment_2(), "rule__Foreach__Exp4Assignment_2");
					put(grammarAccess.getForeachAccess().getExp5Assignment_6(), "rule__Foreach__Exp5Assignment_6");
					put(grammarAccess.getForeachAccess().getCom4Assignment_10(), "rule__Foreach__Com4Assignment_10");
